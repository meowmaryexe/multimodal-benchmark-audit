# Run Qwen2-VL-2B on ChartQAPro with image and no-image conditions
...
# ChartQAPro dataset confirmed from Hugging Face.
DATASET_NAME = "ahmed-masry/ChartQAPro"
SPLIT = "test"

OUTPUT_PATH = "qwen2b_chartqapro_results.csv"
...
# Final run after everything works:
# TOTAL = None
...
print(f"Total examples to run: {total}")
...
with open(OUTPUT_PATH, "a", newline="") as f:
    ...
    for i in range(total):
        ...
        gold = str(example["Answer"][0]).strip()
        chartqapro_question_type = example["Question Type"]
        year = example["Year"]
            ...
            writer.writerow(
                {
                    ...
                    "condition": condition,
                    "category": category,
                    "chartqapro_question_type": chartqapro_question_type,
                    "year": year,
                    "paragraph": paragraph,
                    "question": question,
                    "gold": gold,
...
print("\n=== Qwen2-VL-2B ChartQAPro Breakdown ===")
